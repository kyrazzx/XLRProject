...
from xlr_bot_core import CATEGORY_BO2, HelpView, bot_owner_only, build_help_pages, discord_invite_link, get_prefix_value, xlr_embed
...
class BotCommands(commands.Cog):
    ...
    async def ping(self, ctx):
        ...
        await message.edit(embed=xlr_embed(self.bot, description=f'Pong!\n**Message:** {edit_ms}ms\n**API:** {api_ms}ms'))
    ...
    async def support(self, ctx):
        ...
        await ctx.send(embed=xlr_embed(self.bot, title='XLR Community', description=f'Join the XLR EU community on Discord:\n**{invite}**'))
