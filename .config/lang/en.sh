...
manual_game_files_en="Import game files manually (without torrent) (Y/n)?"
manual_upload_help_en="Place your game files here then re-run install or import-game-files.sh:"
